...
typedef xcore::ModelRunnerProfiler<67> profiler_t;
...
void person_detect_resolver_get(void **v_resolver)
{
  ...
  if (resolver == nullptr) {
    ...
    resolver->AddCustom(tflite::ops::micro::xcore::Add_8_OpCode, tflite::ops::micro::xcore::Register_Add_8());
  }
...
void person_detect_profiler_times_get(uint32_t *count, const uint32_t **times) {
  if (profiler) {
